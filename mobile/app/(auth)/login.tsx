      ...
      <View style={styles.inner}>
        ...
        <View style={styles.tabWrap}>
          ...
          >
            ...
            />
            <Text
              style={[styles.tabText, role === "ADMIN" && styles.tabTextActive]}
            >
              Admin
            </Text>
          </Pressable>
          ...
          >
            <Ionicons
              name="person-outline"
              size={16}
              color={role === "TEACHER" ? Colors.accent : Colors.muted}
            />
            <Text
              style={[
                styles.tabText,
                role === "TEACHER" && styles.tabTextActive,
              ]}
            >
              Teacher
            </Text>
        ...
        <Input
          placeholder={role === "ADMIN" ? "Admin email" : "Teacher email"}
